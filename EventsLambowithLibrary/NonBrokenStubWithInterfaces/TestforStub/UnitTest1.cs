...
namespace TestforStub
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod10()
        {
            ...
            string expectedresult = $" You are drive a {lamborghini.Name} with a {lamborghini.SetEngineName} engine which top speed is set at {lamborghini.TopSpeed} with a {lamborghini.transmission.HowManyGears} transmission";
